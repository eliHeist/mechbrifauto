...
<!-- <div class="sticky top-20 z-30 bg-dark border-b border-white/10 content-grid">
...
{#each categories as cat, i}
	<section
		id={cat.id}
		class="{i % 2 === 0 ? 'bg-black' : 'bg-dark'} py-24 md:py-32 scroll-mt-16">
			...
			<div class="reveal opacity-0 translate-y-8 transition-all duration-700 grid md:grid-cols-2 gap-12 md:gap-20 items-center {i % 2 !== 0 ? 'md:[&>*:first-child]:order-2' : ''}">
				...
				<div>
					...
					<a
						...
						class="mt-10 inline-block font-['Inter'] font-600 text-sm tracking-widest uppercase bg-accent text-white px-10 py-4 hover:bg-red-700 transition-colors">
						Book This Service
					</a>
				</div>
			</div>
...
<!-- ─── BOTTOM CTA ─────────────────────────────────────────────────────────── -->
<section class="bg-black border-t border-white/10 py-28 md:py-40 px-8 md:px-16 text-center">
	<div class="reveal opacity-0 translate-y-8 transition-all duration-700 max-w-2xl mx-auto">
		...
		<a
			href="/contact"
			class="inline-block font-['Inter'] font-600 text-sm tracking-widest uppercase bg-accent text-white px-12 py-5 hover:bg-red-700 transition-colors">
			Get a Diagnosis
		</a>
	</div>
</section>
